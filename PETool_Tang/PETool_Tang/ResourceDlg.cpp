...
ResourceDlg::ResourceDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(Resource, pParent)
{
...
DWORD ResourceDlg::RVAToOffset(IMAGE_DOS_HEADER* pDos, DWORD dwRva)
{
...
void ResourceDlg::parseResourcesTable(DWORD dwResRootDirAddr,/*根目录的首地址*/ IMAGE_RESOURCE_DIRECTORY* pResDir,/*需要解析的资源目录*/ int nDeep /*记录这是第几层目录*/)
{
